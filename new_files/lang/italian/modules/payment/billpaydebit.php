...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'Addebiteremo l\'importo dovuto sul conto specificato nell\'ordine entro i prossimi giorni.');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'Per questo ordine con addebito diretto una tassa di ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', ' sollevato');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Grazie per aver scelto di pagare con addebito diretto con BillPay. Addebiteremo l\'importo dovuto nei prossimi giorni.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'L\'ordine &egrave; stato emesso da ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO3', '');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'La tassa di addebito diretto per questo ordine &egrave; ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', ' sollevato');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_EULA_CHECK', MODULE_PAYMENT_BILLPAY_TEXT_EULA_CHECK);
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_EULA_CHECK_DE', MODULE_PAYMENT_BILLPAY_TEXT_EULA_CHECK_CH);
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_SEPA_INFORMATION_AT', MODULE_PAYMENT_BILLPAY_TEXT_SEPA_INFORMATION_AT);
// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYDEBIT_THANK_YOU_TEXT', 'Grazie per aver scelto l\'addebito diretto BillPay al momento dell\'acquisto.');
define('MODULE_PAYMENT_BILLPAYDEBIT_PAY_UNTIL_TEXT', 'Nei prossimi giorni addebiteremo %1$s %2$s sul seguente conto:');
define('MODULE_PAYMENT_BILLPAYDEBIT_EMAIL_TEXT', 'BillPay vi informer&agrave; in anticipo via e-mail della data di addebito sul vostro conto.');
?>