...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO1', 'Grazie per aver scelto di pagare con PayLater. Gli importi dovuti saranno addebitati sul conto specificato durante l\'ordine. Oltre a questa fattura Billpay le fornir&agrave; a breve un piano di pagamento con informazioni dettagliate sulle sue rate.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO2', 'L\'ordine &egrave; stato emesso da ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO3', '');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO1', 'La tassa PayLater per questo ordine &egrave; ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO2', '');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_PROMO', 'Cliccare sul pulsante di opzione per mostrare di pi&ugrave;.');
// OT
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_FEE', 'Servizio a pagamento');
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_TOTAL',               'Totale + PayLater fee');
define('MODULE_PAYMENT_BILLPAY_GIROPAY_CANCELED', 'Giropay annullato');
define('MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE_TITLE' , 'Modalit&agrave; visiva');
define('MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE_DESC' , '');
// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYPAYLATER_THANK_YOU_TEXT', 'Grazie per aver scelto BillPay PayLater Instalment al momento dell\'acquisto.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_PAY_UNTIL_TEXT', 'Gli importi dovuti saranno addebitati mensilmente sul seguente conto:');
define('MODULE_PAYMENT_BILLPAYPAYLATER_EMAIL_TEXT', 'Oltre alla fattura riceverete a breve un piano di rateizzazione con informazioni dettagliate sui vostri pagamenti.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE', 'PayLater | Rate');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_DESCRIPTION', 'PayLater | Rate');
?>